...
const Home = () => {
    ...
    <div className="flex flex-row justify-around h-[90%]">
        <div className="my-auto mx-12 w-[70%]">
            <h3 className="my-5 h-32 font-bold text-6xl text-transparent bg-clip-text bg-gradient-to-br from-cyan-500 to-blue-500">Craft Your Perfect Calendar: Add Images, Events, and More!</h3>
        ...
        <div className="my-auto transition-all ease-in-out hover:scale-105 mx-12">
            <img src="../landing/front.svg" alt="error" />
        </div>
    </div> );
}
